...
base_url = "https://marsac.mn.gov.in/geoserver"
WMS_VERSION = "1.1.1"
ID_PROP = 'fid'
SORT_KEY = None
#SORT_KEY = 'object_id'
...
def get_layer_list():
    ...
    if not cap_file.exists():
        resp = requests.get(OWS_url, params=capabilities_query_params, verify=False)
        if not resp.ok:
...
if __name__ == '__main__':
    ...
    lnames = ['geo_rism:bishnupurcadastral',
              'geo_rism:kakchingcadastral',
              'geo_rism:keiraobitracadastral',
              'geo_rism:lamphelpatcadastral',
              'geo_rism:lamshangcadastral',
              'geo_rism:lilongcadastral',
              'geo_rism:moirangcadastral',
              'geo_rism:nambolcadastral',
              'geo_rism:patsoicadastral',
              'geo_rism:porompatcadastral',
              'geo_rism:sawombungcadastral',
              'geo_rism:thoubalcadastral',
              'geo_rism:wangoicadastral']
