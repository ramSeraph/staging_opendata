...
base_url = 'https://kgis.ksrsac.in/kgismaps/rest/services'
...
to_scrape = {
    #"CadastralData_Admin/Dynamic_CadastralData_Admin/MapServer": { "whitelist": ["Cadastral_5"] }
    "Home/Home_Department/MapServer": { "whitelist": ["Police Station Juridiction Boundary/Police Station Boundary_82",
                                                      "Police Station Juridiction Boundary/Railway Police Station Boundary_83",
                                                      "Traffic Police Station Boundary_96"] },
    "Stamp_Regst/Stamps_Registration/MapServer": { "whitelist": [ "BBMP Slum Boundary_10" ] }
}
